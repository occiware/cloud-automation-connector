...
/**
 * This is the item provider adapter for a {@link org.occiware.cloudautomation.Cloudautomationinstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CloudautomationinstanceItemProvider extends ComputeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public CloudautomationinstanceItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns Cloudautomationinstance.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Cloudautomationinstance"));
	}
	...
	public String getText(Object object) {
		String label = ((Cloudautomationinstance)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_Cloudautomationinstance_type") :
			getString("_UI_Cloudautomationinstance_type") + " " + label;
	}
		...
		newChildDescriptors.add
			(createChildParameter
				(OCCIPackage.Literals.RESOURCE__LINKS,
				 CloudautomationFactory.eINSTANCE.createCloudautomationnetwork()));
	}
